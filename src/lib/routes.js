...
export default {
    ...
    routes: [
        ...
        },
        {
            ...
            component: Movie,
            before: async (page) => {
                const contents = await Promise.all([getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"), getPopularContent("movie"),]);
                for (let i in contents) {
                    contents[i].children[0].patch({
                        y: i * 500
                    });
                    contents[i].columnIndex = parseInt(i);
                }
